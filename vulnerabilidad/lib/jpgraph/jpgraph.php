...
// Created: 	2001-01-08
// Ver:		$Id: jpgraph.php 769 2006-09-24 20:17:51Z ljp $
//
...
// PUBLIC METHODS	
    ...
    function SetTickLabels($aLabelArray,$aLabelColorArray=null,$fromUtf8=false) {
    	
    	if($fromUtf8)foreach($aLabelArray as &$item)$item = utf8_decode($item);
